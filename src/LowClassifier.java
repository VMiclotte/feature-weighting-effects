...
public class LowClassifier extends AbstractClassifier {
    ...
    public LowClassifier(Instances trainData, int k) {
    ...
    public double low(Instance[] n, double classValue, Instance x) {
        double sum = 0;
        double sum2 = 0;
        ...
        double ret = some.fuzQua(sum / sum2);
        return ret;
    }
}
